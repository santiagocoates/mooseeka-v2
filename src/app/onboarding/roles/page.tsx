...
const ROLES = [
  ...
  { id: 'cantautor',    label: 'Cantautor',            emoji: '🎵', desc: 'Compositor e intérprete' },
  { id: 'banda',        label: 'Banda',                emoji: '🎸', desc: 'Grupo musical' },
  { id: 'dj',           label: 'DJ',                   emoji: '🎧', desc: 'DJ, turntablist' },
  { id: 'compositor',   label: 'Compositor',           emoji: '🎼', desc: 'Escritor de canciones y letras' },
  // Instrumentistas
  ...
  { id: 'sonidista',    label: 'Sonidista Live',       emoji: '🔊', desc: 'Ingeniero de sonido en vivo' },
  // Industria
  { id: 'sello',        label: 'Sello Discográfico',   emoji: '🏷️', desc: 'Label, distribución, A&R' },
  { id: 'manager',      label: 'Manager',              emoji: '📋', desc: 'Artist manager, representante' },
  { id: 'ar',           label: 'A&R',                  emoji: '🔍', desc: 'Scouting y desarrollo de artistas' },
  ...
  { id: 'locutor',      label: 'Locutor / Podcaster',  emoji: '📻', desc: 'Radio, podcast, narración' },
